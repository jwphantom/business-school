...
export class AdmissionComponent implements OnInit {
  ...
  addAdmissionForm() {
    this.admissionForm = this.formBuilder.group({
      program: ['Douane / Transit', Validators.required],
      concours: ["Concours du 28 Octobre 2023", Validators.required],
  ...
  submitAdmission() {
    ...
    this.http
      .post<any[]>(`${this.baseUrl}/submission/bs/add-admission`, responseForm)
      .subscribe(
        (response) => {
